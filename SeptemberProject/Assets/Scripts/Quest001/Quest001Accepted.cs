...
public class Quest001Accepted : MonoBehaviour {
	...
	void Update () {
		if (MushroomManager.MushroomCount >= 3) {
			QuestGiver001.GetComponent<Quest001Finished>().enabled = true;
			GetComponent<Quest001Accepted>().enabled = false;
		}
